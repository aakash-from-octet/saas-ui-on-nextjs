...
import { Table, Button, Dropdown, Menu, Image, Row, Col, Input, Tooltip } from 'antd';
import Layout from '@/Components/Common/Layout';
import { DOT, NODOC, SEARCHINPUT } from '@/Components/utils/image-constants';
import type { MenuProps } from 'antd';
import { useCallback, useEffect, useState } from 'react';
import EditResendModal from '@/Components/Modal/EditResend';
...
export default function AllDocuments({ }) {
  ...
  const fetchDocuments = useCallback(async () => {
    ...
    try {
      ...
      let status = selectedStatus === "in-progress" && "Inprogress" ;
    ...
    },
    {
      ...
      render: status => {
        return (<div className='div-row gap-12 align-center'>
          <Link href={`${vanity}/product-signed-successful`}><Button className='gray-btn'>View Details</Button></Link>
