...
import { setLoadingState } from "@/redux/action";

const SelectedSigneeOption = ({
    className,
    styleColor,
...
const dispatch =useDispatch()
    ...
    useEffect(() => {
        ...
        const fetchDocumentDetails = async () => {
            console.log("Dispatching setLoadingState(true)");
            ...
            try {
                ...
                const fetchedSignees = response?.data?.documentSignerDetails?.signers;

                // Assign colors to each signee
               if(response.data.success)
               {
                dispatch(setLoadingState(false));
                const signeesWithColors = assignColorsToSignees(fetchedSignees, signeeColors);
                console.log("Signees with colors:", signeesWithColors); 
...
export default SelectedSigneeOption;