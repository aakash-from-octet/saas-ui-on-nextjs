...
const EditContactModal = ({getContact}:{getContact?:any}) => {

    // these details will be prefilled with the API values 
    ...
    return (
        <>
            <p className='text-12 font-500 text-gray' onClick={showModal}>Edit Information</p>
            <Modal
                width={370}
                centered
                title={<p className="text-p text-18 font-600">Edit contact</p>}
                open={isModalOpen}
                footer={null}
                closeIcon={
                    <Image
